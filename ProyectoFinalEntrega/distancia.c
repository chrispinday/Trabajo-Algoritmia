...
float calcularDistancia(tipoDia dia1, tipoDia dia2) {
    ...
    // --- 1. Atributos Numéricos (8 atributos) ---
    // (Se asume que ya están normalizados entre 0 y 1)
    ...
    // ---  Atributo Categórico (RainToday) ---
    // Si son diferentes suma 1, si son iguales suma 0
    sumatorio += (dia1.rainToday != dia2.rainToday);


    // Devolvemos la raíz cuadrada (Distancia Euclídea)
